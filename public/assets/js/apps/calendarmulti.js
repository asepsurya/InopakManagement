...
jQueryScript.setAttribute('src','https://cdn.jsdelivr.net/npm/fullcalendar@6.1.10/index.global.min.js');
                    ...
                    c = new FullCalendar.Calendar(e, {
                        ...
                        eventClick: function(e) {
                            var t = e.event._def.title,
                                ...
                                i = (f("#edit-event-title").val(t), f("#edit-event-start-date").val(i)
                        ...
                        events: [
                            ...
                            description: "ini adalah contoh sample Deskripsi"
                        },
